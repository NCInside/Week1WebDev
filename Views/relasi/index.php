...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarsExample02">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="index.php">Relasi <span class="sr-only">(current)</span></a>
        </li>
        </ul>
    </div>
    </nav>
    ...
    <tbody>
        ...
        foreach(indexRelasi() as $index=>$relasi) {
            ...
            <tr>
                ...
                <td><a href="update.php?uid=<?=$relasi->getUid()?>"><button class="btn btn-primary">Update</button></a></td>
            </tr>
